...
NUM_100,NUM_150,NUM_200,NUM_220)
...
class GUIFe2Temperatura(QMainWindow):
    def __init__( self ):
        ...
        self.SPINR3_MINIMO.setMaximum(NUM_200)
        ...
        self.spinr2_3.setMaximum(NUM_200)
        ...
        self.botao2_r3.clicked.connect(self.gravar_dbTEMP)
        ...
        self.QCB_C_3.clicked.connect(self.check_box_estado_TEMP)
